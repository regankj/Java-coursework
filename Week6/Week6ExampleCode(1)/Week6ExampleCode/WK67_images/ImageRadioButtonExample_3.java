...
public class ImageRadioButtonExample_3 extends Application {
    ...
    String analogWatch = "http://users.cs.cf.ac.uk/Dave.Marshall/CMT205/Code/ImageRadioButtonExample/src/analog.png";
    String hourGlass = "http://users.cs.cf.ac.uk/Dave.Marshall/CMT205/Code/ImageRadioButtonExample/src/hourglass.png";
    String stopWatch = "http://users.cs.cf.ac.uk/Dave.Marshall/CMT205/Code/ImageRadioButtonExample/src/stopwatch.png";
    ...
    public void start(Stage myStage) {
        ...
        rbAnalog.setGraphic(new ImageView(analogWatch));
        rbHourglass.setGraphic(new ImageView(hourGlass));
        rbStopwatch.setGraphic(new ImageView(stopWatch));
