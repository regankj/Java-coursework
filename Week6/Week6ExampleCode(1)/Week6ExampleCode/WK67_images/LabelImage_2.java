...
public class LabelImage_2 extends Application {

    String woodland = "http://users.cs.cf.ac.uk/Dave.Marshall/CMT205/Code/ImageDisplay/src/woodland.png";
    ...
    public void start(Stage myStage) {
        ...
        Image imgWoodland = new Image(woodland, 100, 100, true, true);
