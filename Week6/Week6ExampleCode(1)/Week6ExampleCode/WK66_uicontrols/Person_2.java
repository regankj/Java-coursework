...
public class Person_2 {
    ...
    private ObservableList<Person_2> employees = FXCollections.observableArrayList();
    ...
    public ObservableList<Person_2> employeesProperty() {
        return employees;
    }

    public Person_2(String alias, String firstName, String lastName) {
        setAliasName(alias);
